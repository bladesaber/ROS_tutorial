...
"""autogenerated by genpy from basic/TimerActionResult.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','basic/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = basic.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = basic.msg.TimerResult()
