  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.data:
        ...
        buff.write(_get_struct_B().pack(_v1.state))
        _v2 = val1.commandMode
        buff.write(_get_struct_B().pack(_v2.state))
        _v3 = val1.calibrationMode
        buff.write(_get_struct_B().pack(_v3.state))
        _v4 = val1.clearFaultMode
        buff.write(_get_struct_B().pack(_v4.state))
        _v5 = val1.coeffState
        buff.write(_get_struct_B().pack(_v5.state))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.data:
        ...
        buff.write(_get_struct_B().pack(_v11.state))
        _v12 = val1.commandMode
        buff.write(_get_struct_B().pack(_v12.state))
        _v13 = val1.calibrationMode
        buff.write(_get_struct_B().pack(_v13.state))
        _v14 = val1.clearFaultMode
        buff.write(_get_struct_B().pack(_v14.state))
        _v15 = val1.coeffState
        buff.write(_get_struct_B().pack(_v15.state))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
