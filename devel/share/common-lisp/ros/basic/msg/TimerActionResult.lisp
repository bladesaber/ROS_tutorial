...
(cl:defclass <TimerActionResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (result
    :reader result
    :initarg :result
    :type basic-msg:TimerResult
    :initform (cl:make-instance 'basic-msg:TimerResult)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerActionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerActionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-msg:<TimerActionResult> is deprecated: use basic-msg:TimerActionResult instead.")))
