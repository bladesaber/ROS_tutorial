...
(cl:defclass <TimerActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type basic-msg:TimerGoal
    :initform (cl:make-instance 'basic-msg:TimerGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-msg:<TimerActionGoal> is deprecated: use basic-msg:TimerActionGoal instead.")))
