...
(cl:defmethod cl:initialize-instance :after ((m <TimerGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-msg:<TimerGoal> is deprecated: use basic-msg:TimerGoal instead.")))

(cl:ensure-generic-function 'time_to_wait-val :lambda-list '(m))
(cl:defmethod time_to_wait-val ((m <TimerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basic-msg:time_to_wait-val is deprecated.  Use basic-msg:time_to_wait instead.")
  (time_to_wait m))
