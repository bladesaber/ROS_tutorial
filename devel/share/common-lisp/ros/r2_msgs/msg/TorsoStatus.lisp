...
(cl:defmethod cl:initialize-instance :after ((m <TorsoStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TorsoStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<TorsoStatus> is deprecated: use r2_msgs-msg:TorsoStatus instead.")))

(cl:ensure-generic-function 'leftarm-val :lambda-list '(m))
(cl:defmethod leftarm-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:leftarm-val is deprecated.  Use r2_msgs-msg:leftarm instead.")
  (leftarm m))

(cl:ensure-generic-function 'rightarm-val :lambda-list '(m))
(cl:defmethod rightarm-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:rightarm-val is deprecated.  Use r2_msgs-msg:rightarm instead.")
  (rightarm m))

(cl:ensure-generic-function 'neck-val :lambda-list '(m))
(cl:defmethod neck-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:neck-val is deprecated.  Use r2_msgs-msg:neck instead.")
  (neck m))

(cl:ensure-generic-function 'lefthand-val :lambda-list '(m))
(cl:defmethod lefthand-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:lefthand-val is deprecated.  Use r2_msgs-msg:lefthand instead.")
  (lefthand m))

(cl:ensure-generic-function 'righthand-val :lambda-list '(m))
(cl:defmethod righthand-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:righthand-val is deprecated.  Use r2_msgs-msg:righthand instead.")
  (righthand m))

(cl:ensure-generic-function 'waist-val :lambda-list '(m))
(cl:defmethod waist-val ((m <TorsoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:waist-val is deprecated.  Use r2_msgs-msg:waist instead.")
  (waist m))
