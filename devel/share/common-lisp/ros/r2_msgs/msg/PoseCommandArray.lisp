...
(cl:defclass <PoseCommandArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (command
    :reader command
    :initarg :command
    :type (cl:vector r2_msgs-msg:PoseCommand)
   :initform (cl:make-array 0 :element-type 'r2_msgs-msg:PoseCommand :initial-element (cl:make-instance 'r2_msgs-msg:PoseCommand))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PoseCommandArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseCommandArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<PoseCommandArray> is deprecated: use r2_msgs-msg:PoseCommandArray instead.")))
...
(cl:defmethod command-val ((m <PoseCommandArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:command-val is deprecated.  Use r2_msgs-msg:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PoseCommandArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'command)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'r2_msgs-msg:PoseCommand))
