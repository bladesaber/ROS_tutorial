...
(cl:defmethod cl:initialize-instance :after ((m <PoseCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<PoseCommand> is deprecated: use r2_msgs-msg:PoseCommand instead.")))

(cl:ensure-generic-function 'commandId-val :lambda-list '(m))
(cl:defmethod commandId-val ((m <PoseCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:commandId-val is deprecated.  Use r2_msgs-msg:commandId instead.")
  (commandId m))

(cl:ensure-generic-function 'refFrame-val :lambda-list '(m))
(cl:defmethod refFrame-val ((m <PoseCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:refFrame-val is deprecated.  Use r2_msgs-msg:refFrame instead.")
  (refFrame m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <PoseCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:pose-val is deprecated.  Use r2_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'baseFrame-val :lambda-list '(m))
(cl:defmethod baseFrame-val ((m <PoseCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:baseFrame-val is deprecated.  Use r2_msgs-msg:baseFrame instead.")
  (baseFrame m))

(cl:ensure-generic-function 'toolFrame-val :lambda-list '(m))
(cl:defmethod toolFrame-val ((m <PoseCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:toolFrame-val is deprecated.  Use r2_msgs-msg:toolFrame instead.")
  (toolFrame m))
