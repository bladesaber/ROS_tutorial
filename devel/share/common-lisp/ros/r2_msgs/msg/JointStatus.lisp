...
(cl:defmethod cl:initialize-instance :after ((m <JointStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<JointStatus> is deprecated: use r2_msgs-msg:JointStatus instead.")))

(cl:ensure-generic-function 'publisher-val :lambda-list '(m))
(cl:defmethod publisher-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:publisher-val is deprecated.  Use r2_msgs-msg:publisher instead.")
  (publisher m))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:joint-val is deprecated.  Use r2_msgs-msg:joint instead.")
  (joint m))

(cl:ensure-generic-function 'registerValue-val :lambda-list '(m))
(cl:defmethod registerValue-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:registerValue-val is deprecated.  Use r2_msgs-msg:registerValue instead.")
  (registerValue m))

(cl:ensure-generic-function 'bridgeEnabled-val :lambda-list '(m))
(cl:defmethod bridgeEnabled-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:bridgeEnabled-val is deprecated.  Use r2_msgs-msg:bridgeEnabled instead.")
  (bridgeEnabled m))

(cl:ensure-generic-function 'motorEnabled-val :lambda-list '(m))
(cl:defmethod motorEnabled-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:motorEnabled-val is deprecated.  Use r2_msgs-msg:motorEnabled instead.")
  (motorEnabled m))

(cl:ensure-generic-function 'brakeReleased-val :lambda-list '(m))
(cl:defmethod brakeReleased-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:brakeReleased-val is deprecated.  Use r2_msgs-msg:brakeReleased instead.")
  (brakeReleased m))

(cl:ensure-generic-function 'motorPowerDetected-val :lambda-list '(m))
(cl:defmethod motorPowerDetected-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:motorPowerDetected-val is deprecated.  Use r2_msgs-msg:motorPowerDetected instead.")
...
(cl:defmethod embeddedMotCom-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:embeddedMotCom-val is deprecated.  Use r2_msgs-msg:embeddedMotCom instead.")
  (embeddedMotCom m))

(cl:ensure-generic-function 'jointFaulted-val :lambda-list '(m))
(cl:defmethod jointFaulted-val ((m <JointStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:jointFaulted-val is deprecated.  Use r2_msgs-msg:jointFaulted instead.")
  (jointFaulted m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<JointStatus>)))
  ...
  "03efe3c55d2652ccbab38921d83a5f63")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'JointStatus)))
  "Returns md5sum for a message object of type 'JointStatus"
  "03efe3c55d2652ccbab38921d83a5f63")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointStatus>)))
  ...
  (cl:format cl:nil "string publisher~%string joint~%uint32 registerValue~%bool bridgeEnabled~%bool motorEnabled~%bool brakeReleased~%bool motorPowerDetected~%bool embeddedMotCom~%bool jointFaulted~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointStatus)))
  "Returns full string definition for message of type 'JointStatus"
  (cl:format cl:nil "string publisher~%string joint~%uint32 registerValue~%bool bridgeEnabled~%bool motorEnabled~%bool brakeReleased~%bool motorPowerDetected~%bool embeddedMotCom~%bool jointFaulted~%~%~%"))
