...
(cl:defmethod cl:initialize-instance :after ((m <PoseCommandParams>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseCommandParams)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<PoseCommandParams> is deprecated: use r2_msgs-msg:PoseCommandParams instead.")))

(cl:ensure-generic-function 'maxLinVel-val :lambda-list '(m))
(cl:defmethod maxLinVel-val ((m <PoseCommandParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:maxLinVel-val is deprecated.  Use r2_msgs-msg:maxLinVel instead.")
  (maxLinVel m))

(cl:ensure-generic-function 'maxRotVel-val :lambda-list '(m))
(cl:defmethod maxRotVel-val ((m <PoseCommandParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:maxRotVel-val is deprecated.  Use r2_msgs-msg:maxRotVel instead.")
  (maxRotVel m))
