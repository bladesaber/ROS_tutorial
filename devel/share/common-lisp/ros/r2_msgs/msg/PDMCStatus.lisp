...
(cl:defmethod cl:initialize-instance :after ((m <PDMCStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PDMCStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<PDMCStatus> is deprecated: use r2_msgs-msg:PDMCStatus instead.")))
...
(cl:defmethod logicEnabled-val ((m <PDMCStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:logicEnabled-val is deprecated.  Use r2_msgs-msg:logicEnabled instead.")
  (logicEnabled m))
