...
(cl:defmethod cl:initialize-instance :after ((m <PoseTwistStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseTwistStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-msg:<PoseTwistStamped> is deprecated: use r2_msgs-msg:PoseTwistStamped instead.")))
...
(cl:defmethod twist-val ((m <PoseTwistStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-msg:twist-val is deprecated.  Use r2_msgs-msg:twist instead.")
  (twist m))
