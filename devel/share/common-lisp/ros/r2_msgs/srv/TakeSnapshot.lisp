...
(cl:defmethod cl:initialize-instance :after ((m <TakeSnapshot-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakeSnapshot-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<TakeSnapshot-request> is deprecated: use r2_msgs-srv:TakeSnapshot-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <TakeSnapshot-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakeSnapshot-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<TakeSnapshot-response> is deprecated: use r2_msgs-srv:TakeSnapshot-response instead.")))
