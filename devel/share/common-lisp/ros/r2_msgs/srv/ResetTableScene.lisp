...
(cl:defmethod cl:initialize-instance :after ((m <ResetTableScene-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetTableScene-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<ResetTableScene-request> is deprecated: use r2_msgs-srv:ResetTableScene-request instead.")))

(cl:ensure-generic-function 'reset-val :lambda-list '(m))
(cl:defmethod reset-val ((m <ResetTableScene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:reset-val is deprecated.  Use r2_msgs-srv:reset instead.")
  (reset m))
...
(cl:defmethod cl:initialize-instance :after ((m <ResetTableScene-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetTableScene-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<ResetTableScene-response> is deprecated: use r2_msgs-srv:ResetTableScene-response instead.")))
