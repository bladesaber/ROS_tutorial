...
(cl:defmethod cl:initialize-instance :after ((m <ParseTableScene-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParseTableScene-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<ParseTableScene-request> is deprecated: use r2_msgs-srv:ParseTableScene-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <ParseTableScene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:cmd-val is deprecated.  Use r2_msgs-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod cl:initialize-instance :after ((m <ParseTableScene-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParseTableScene-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<ParseTableScene-response> is deprecated: use r2_msgs-srv:ParseTableScene-response instead.")))

(cl:ensure-generic-function 'table_found-val :lambda-list '(m))
(cl:defmethod table_found-val ((m <ParseTableScene-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:table_found-val is deprecated.  Use r2_msgs-srv:table_found instead.")
  (table_found m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <ParseTableScene-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:markers-val is deprecated.  Use r2_msgs-srv:markers instead.")
  (markers m))
