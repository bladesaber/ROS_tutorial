...
(cl:defmethod cl:initialize-instance :after ((m <Power-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Power-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<Power-request> is deprecated: use r2_msgs-srv:Power-request instead.")))

(cl:ensure-generic-function 'channel-val :lambda-list '(m))
(cl:defmethod channel-val ((m <Power-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:channel-val is deprecated.  Use r2_msgs-srv:channel instead.")
  (channel m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Power-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:state-val is deprecated.  Use r2_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod cl:initialize-instance :after ((m <Power-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Power-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<Power-response> is deprecated: use r2_msgs-srv:Power-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <Power-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:status-val is deprecated.  Use r2_msgs-srv:status instead.")
  (status m))
