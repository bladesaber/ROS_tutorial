...
(cl:defmethod cl:initialize-instance :after ((m <SetTipName-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTipName-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<SetTipName-request> is deprecated: use r2_msgs-srv:SetTipName-request instead.")))

(cl:ensure-generic-function 'arm_name-val :lambda-list '(m))
(cl:defmethod arm_name-val ((m <SetTipName-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:arm_name-val is deprecated.  Use r2_msgs-srv:arm_name instead.")
  (arm_name m))

(cl:ensure-generic-function 'tip_name-val :lambda-list '(m))
(cl:defmethod tip_name-val ((m <SetTipName-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:tip_name-val is deprecated.  Use r2_msgs-srv:tip_name instead.")
  (tip_name m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetTipName-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTipName-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<SetTipName-response> is deprecated: use r2_msgs-srv:SetTipName-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SetTipName-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:result-val is deprecated.  Use r2_msgs-srv:result instead.")
  (result m))
