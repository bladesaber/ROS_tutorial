...
(cl:defmethod cl:initialize-instance :after ((m <Servo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<Servo-request> is deprecated: use r2_msgs-srv:Servo-request instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <Servo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2_msgs-srv:joint-val is deprecated.  Use r2_msgs-srv:joint instead.")
  (joint m))
...
(cl:defmethod cl:initialize-instance :after ((m <Servo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<Servo-response> is deprecated: use r2_msgs-srv:Servo-response instead.")))
