...
(cl:defmethod cl:initialize-instance :after ((m <SetJointMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<SetJointMode-request> is deprecated: use r2_msgs-srv:SetJointMode-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetJointMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2_msgs-srv:<SetJointMode-response> is deprecated: use r2_msgs-srv:SetJointMode-response instead.")))
